...
{
	DECLARE_DATATYPE(SysPrePosition);
...
{
	DECLARE_DATATYPE(EntityMotionParam);
...
{
	DECLARE_DATATYPE(SysMotionUpdate);
...
{
	DECLARE_DATATYPE(SimEventParamBase);
};
...
{
	DECLARE_DATATYPE(SimEventParam2);
...
{
	DECLARE_DATATYPE(SimEventParam101);
...
{
	DECLARE_DATATYPE(SimEventParam102);
...
{
	DECLARE_DATATYPE(SimEventParam103);
...
{
	DECLARE_DATATYPE(SimEventParam104);
...
{
	DECLARE_DATATYPE(MissileSend201);
...
{
	DECLARE_DATATYPE(MissileBomb202);
...
{
	DECLARE_DATATYPE(ShiftTarget203);
...
{
	DECLARE_DATATYPE(ShiftGuide204);
...
{
	DECLARE_DATATYPE(SimEventDescribe);
...
{
	DECLARE_DATATYPE(UpdateNavigationInfo);
...
{
	DECLARE_DATATYPE(UpdateScenarioData);
...
{
	DECLARE_DATATYPE(ReportRadarEvent);
...
{
	DECLARE_DATATYPE(ReportRadarTrace);
...
{
	DECLARE_DATATYPE(ReportRadarTrack);
};
...
{
	DECLARE_DATATYPE(ReportSysStop);
...
{
	DECLARE_DATATYPE(RadiationSocDetail);
...
{
	DECLARE_DATATYPE(SCRespondDetial);
...
{
	DECLARE_DATATYPE(SelfCheckReply);
...
{
	DECLARE_DATATYPE(PrePosReportDetial);
...
{
	DECLARE_DATATYPE(ResponseStateDetial);
...
{
	DECLARE_DATATYPE(ResponseState);
...
{
	DECLARE_DATATYPE(EquipCommandDetial);
...
{
	DECLARE_DATATYPE(ReportRadarParam);
...
{
	DECLARE_DATATYPE(ReportSorting);
